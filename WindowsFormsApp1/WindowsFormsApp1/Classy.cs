    ...
    public partial class Classy : Form
    {
        ...
        public Classy()
        {
            ...
            switch (color)
            {
                ...
                case 2:
                    bg = System.Drawing.ColorTranslator.FromHtml("#DF964A");
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            label2.BackColor = bg;
            label2.Font = new Font(classFont.Families[1], 36);
            label2.Text = strName;
            ...
            label3.Text = strURL;
            label3.Top = label1.Bottom - 4;
            label3.Left = label1.Left + 60;

            label4.BackColor = bg;
            label4.Font = new Font(classFont.Families[0], 17);
            label4.Text = "Contact: " + strContact;
            label4.Top = label2.Bottom - 8;
            label4.Left = label2.Left+30;

            label5.BackColor = bg;
            label5.Font = new Font(classFont.Families[0], 17);
